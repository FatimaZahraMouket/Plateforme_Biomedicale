...
import com.appbiomedicale.repository.BoitierRepository;
...
/**
 * REST controller for managing {@link com.appbiomedicale.domain.Boitier}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BoitierResource {
     ...
     */
    @GetMapping("/boitiers")
    public ResponseEntity<List<Boitier>> getAllBoitiers(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Boitiers");
        Page<Boitier> page = boitierRepository.findAll(pageable);
