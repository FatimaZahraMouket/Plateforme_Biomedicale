...
import com.appbiomedicale.repository.BoitierCapteurRepository;
...
/**
 * REST controller for managing {@link com.appbiomedicale.domain.BoitierCapteur}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BoitierCapteurResource {
    ...
    public ResponseEntity<List<BoitierCapteur>> getAllBoitierCapteurs(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of BoitierCapteurs");
        Page<BoitierCapteur> page = boitierCapteurRepository.findAll(pageable);
