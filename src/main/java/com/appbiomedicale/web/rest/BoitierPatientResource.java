...
import com.appbiomedicale.repository.BoitierPatientRepository;
...
/**
 * REST controller for managing {@link com.appbiomedicale.domain.BoitierPatient}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BoitierPatientResource {
    ...
    public ResponseEntity<List<BoitierPatient>> getAllBoitierPatients(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of BoitierPatients");
        Page<BoitierPatient> page = boitierPatientRepository.findAll(pageable);
