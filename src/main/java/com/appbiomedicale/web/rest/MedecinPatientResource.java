...
import com.appbiomedicale.repository.MedecinPatientRepository;
...
/**
 * REST controller for managing {@link com.appbiomedicale.domain.MedecinPatient}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class MedecinPatientResource {
    ...
    public ResponseEntity<List<MedecinPatient>> getAllMedecinPatients(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of MedecinPatients");
        Page<MedecinPatient> page = medecinPatientRepository.findAll(pageable);
