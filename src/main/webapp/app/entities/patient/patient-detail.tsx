...
export const PatientDetail = () => {
  ...
  const matchingMedecinPatient = medecinPatientEnttity.find(medecinpatient => medecinpatient.patients && medecinpatient.patients.id === patientEntity.id && medecinpatient.dateFin === '0001-01-01');
